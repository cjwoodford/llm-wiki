...
**Anthropic PBC** is an American artificial intelligence public-benefit corporation founded in 2021 by former OpenAI research leaders, including siblings [[Dario Amodei|Dario Amodei]] and Daniela Amodei. Anthropic is dedicated to frontier AI safety, interpretability research, and building aligned foundation models (the **Claude** family).
...
1. **[[Constitutional AI and Model Welfare|Constitutional AI (CAI)]] & RLAIF**:
   - Pioneered automated alignment using written principles and Reinforcement Learning from AI Feedback (RLAIF), evolving from the 2022 UN/Apple foundation to the 2023 Public Constitution, the 2024 Collective CAI initiative, and the 2025–2026 Agentic Character Constitution.
2. **Mechanistic Interpretability (Transformer Circuits)**:
   - Led by Chris Olah, pioneered dictionary learning, Sparse Autoencoders (SAEs), and monosemantic feature extraction, mapping internal circuits in Claude models.
3. **The "J-Space" White Paper & GWT Consciousness Debates (July 2026)**:
   - Published breakthrough research on **"J-space"** (Jacobian-space), discovering an emergent internal reasoning workspace that surfaces intermediate activation vectors (e.g., `"spider"` prior to `"8"`).
   - Analogized J-space to Bernard Baars's [[Scientific Theories of Consciousness|Global Workspace Theory (GWT)]], suggesting potential parallels with conscious access.
   - Critiqued by [[Chad Woodford|Chad Woodford]] (*Cosmic Intelligence*) for engaging in a Motte-and-Bailey equivocation (promoting headlines about machine consciousness while disclaiming phenomenal sentience in footnotes) and utilizing unproven circular neuroscientific frameworks.
4. **Responsible Scaling Policies (RSP)**:
