...
## 🔄 Recent Activity (2026-08-31)

- **Ingestion & Synthesis of Anil Seth's "The Mythology of Conscious AI" (*Noema Magazine*)**:
  - Ingested and archived primary clipping to `sources/archive/2026-01-14-anil-seth-the-mythology-of-conscious-ai.md`.
  - Cleared incoming queues (`Clippings/` and duplicate removal in `sources/unread/`).
  - **Entity Deepening**: Substantially expanded [[Anil Seth|Anil Seth]] with his four core anti-functionalist arguments (Brains ≠ Computers, Beyond Turing World, Life Matters, Simulation ≠ Instantiation), refutation of Chalmers' neural replacement thought experiment and Bostrom's simulation argument, cognitive pareidolia, the Garland Test, and the living soul (*psychē/anima/nephesh/Ātman* vs. Cartesian silicon rapture).
  - **Concept Deepening**:
    - [[AI Consciousness and Sentience|AI Consciousness, Sentience & The Consciousness Refinery]]: Structured around the tri-partite distinction between Intelligence (*doing*), Consciousness (*being*), and Sentience (*valence*); incorporated the Garland Test, confabulation vs. hallucination, and the dual hazards of conscious vs. conscious-seeming AI.
    - [[Computation vs Nature and the Observer-Relative Fallacy]]: Added Section 5 detailing Seth's simulation vs. instantiation thesis and Tim van Gelder's Watt Governor dynamical systems critique.
    - [[Scientific Theories of Consciousness]]: Enriched the Predictive Processing section with metabolic autopoiesis, thermodynamic free energy minimization, and biological naturalism.

---

## 🔄 Recent Activity (2026-08-29)

- **Ingestion & Synthesis of The Founding of Neuroscience (Functionalism & Transatlantic Origins)**:
  - Ingested primary source record into `sources/archive/2026-08-29-the-founding-of-neuroscience-functionalism-and-institutional-origins.md`.
  - **Core Concept Deepening**: Enriched [[Neuroscience|Neuroscience: Origins, Evolution & Developmental Milestones]] with the 1940s–1950s cybernetic foundations (McCulloch-Pitts logic gates, Macy Conferences), Barlow's Efficient Coding Hypothesis (action potentials as Shannon bits), the transatlantic matrix (European empirical biology vs. American institutional synthesis), and the Sloan Centers for Theoretical Neuroscience.
  - **Entity Deepening**: Enriched [[Francis O. Schmitt]] with his recasting of biological wetware as bio-electrical communication networks; enriched [[Alfred P. Sloan Foundation]] with the creation of the Sloan Centers for Theoretical Neuroscience (Caltech, Columbia, NYU, Brandeis, Salk) and the abstraction of the point-neuron model.
...
- **[[John McCarthy|John McCarthy]]** — Coined "Artificial Intelligence", organized 1956 Dartmouth workshop, created Lisp (1958) and time-sharing.
- **[[Marvin Minsky|Marvin Minsky]]** — Dartmouth co-founder, MIT AI Lab co-founder, *Society of Mind*, frame theory, and synthetic cognitive architectures.
- **[[Claude Shannon|Claude Shannon]]** — Father of Information Theory (1948), boolean switching circuits, bits, channel capacity, and entropy.
- **[[Allen Newell|Allen Newell]]** & **[[Herbert Simon|Herbert Simon]]** — Logic Theorist (1956), GPS, Physical Symbol System Hypothesis, Turing Award (1975), and Simon's Nobel Prize (1978).
- **[[Noam Chomsky|Noam Chomsky]]** — Generative grammar, Chomsky hierarchy, innatism, and the 1959 overthrow of behaviorism.
...
- **[[Steven Horst|Steven Horst]]** — Philosopher of mind, author of the SEP entry on CTM, and originator of the semantic equivocity critique.
- **[[Bernardo Kastrup|Bernardo Kastrup]]** — Analytic Idealism, cosmic mind, and dissociation.
- **[[Stanislas Dehaene|Stanislas Dehaene]]** — Global Neuronal Workspace Theory (GNWT).
...
- **[[Slavoj Žižek|Slavoj Žižek]]** — Lacanian cultural theorist, ideology, and commodification of dissent.
- **[[Aníbal Quijano|Aníbal Quijano]]** — Peruvian sociologist, formulator of the Coloniality of Power.
- **[[Walter Mignolo|Walter Mignolo]]** — Decolonial theorist, Epistemic Disobedience, and the Pluriverse.
- **[[Donna Haraway|Donna Haraway]]** — Multispecies feminist theorist, *Cyborg Manifesto*, *Staying with the Trouble*.
- **[[Yuval Noah Harari|Yuval Noah Harari]]** — Author of *Sapiens* and *Homo Deus*, architect of Dataism.
